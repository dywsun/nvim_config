...
nnoremap('<leader>sv', '<cmd>lua require("plugins.mytelescope").nvim_config()<CR>')
nnoremap('<leader>sz', '<cmd>lua require("plugins.mytelescope").zsh_config()<CR>')
nnoremap('<leader>sx', '<cmd>lua require("plugins.mytelescope").xconfig()<CR>')
nnoremap('<leader>sp', '<cmd>lua require("plugins.mytelescope").select_project()<CR>')
nnoremap('<leader>ss', '<cmd>lua require("plugins.mytelescope").search_string()<CR>')
nnoremap('<leader>sc', '<cmd>lua require("plugins.mytelescope").change_cwd()<CR>')
nnoremap('<leader>sf', '<Cmd>TSToolsRemoveUnusedImports<CR>')
nnoremap('<leader>sm', '<Cmd>TSToolsRemoveUnused<CR>')

nnoremap('<leader>cp', '<Cmd>lua require("wintersun.plugins.cocosframe").copy_popup()<CR>')
nnoremap('<leader>ck', '<Cmd>lua require("wintersun.plugins.cocosframe").remove_popup()<CR>')
